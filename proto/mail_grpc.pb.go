...
const (
	...
	MailingListService_Getmail_FullMethodName       = "/proto.MailingListService/Getmail"
...
type MailingListServiceClient interface {
	...
	Getmail(ctx context.Context, in *GetEmailRequest, opts ...grpc.CallOption) (*EmailResponse, error)
...
func (c *mailingListServiceClient) Getmail(ctx context.Context, in *GetEmailRequest, opts ...grpc.CallOption) (*EmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmailResponse)
	err := c.cc.Invoke(ctx, MailingListService_Getmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MailingListServiceServer interface {
	...
	Getmail(context.Context, *GetEmailRequest) (*EmailResponse, error)
...
func (UnimplementedMailingListServiceServer) Getmail(context.Context, *GetEmailRequest) (*EmailResponse, error) {
...
func (UnimplementedMailingListServiceServer) GetEmailBatch(context.Context, *GetEmailBatchRequest) (*GetEmailBatchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEmailBatch not implemented")
}
...
func _MailingListService_Getmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailingListServiceServer).Getmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MailingListService_Getmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailingListServiceServer).Getmail(ctx, req.(*GetEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MailingListService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Getmail",
			Handler:    _MailingListService_Getmail_Handler,
		},
		{
